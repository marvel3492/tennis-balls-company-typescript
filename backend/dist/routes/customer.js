        ...
        if (err) {
            ...
            if (result[0]) {
                if (typeof result[0] === "object" &&
                    "password" in result[0] && typeof result[0].password === "string") {
                    ...
                    compare(req.body.password, result[0].password, function (err, result2) {
                        if (err) {
                            ...
                            if (result[0] && typeof result[0] === "object" &&
                                "customer_id" in result[0] && typeof result[0].customer_id === "number" &&
                                "firstname" in result[0] && typeof result[0].firstname === "string" &&
                                "lastname" in result[0] && typeof result[0].lastname === "string" &&
                                "isadmin" in result[0] && typeof result[0].isadmin === "number") {
